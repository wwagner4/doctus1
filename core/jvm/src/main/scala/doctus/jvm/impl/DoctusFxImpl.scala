...
private[jvm] trait DoctusDraggableFxImpl extends DoctusDraggable {
  ...
  comp.setOnMouseDragEntered(DoctusJvmUtil.handler { _ =>
    println("onDragEntered...")
  })
  comp.setOnMouseDragExited(DoctusJvmUtil.handler { _ =>
  ...
  comp.setOnMouseDragOver(DoctusJvmUtil.handler { _ =>
    println("onDragOver...")
  })
  comp.setOnMouseDragReleased(DoctusJvmUtil.handler { _ =>
