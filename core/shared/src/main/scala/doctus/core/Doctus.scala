...
trait DoctusColor {
  ...
  /** Returns the red, green and blue values of the colors The values range from
    * 0 to 255
    */
  def rgb: (Int, Int, Int)
...
trait DoctusImage {
  ...
  /** Returns a new instance of DoctusImage which size is the size of the
    * original image multiplied by 'factor'
    */
...
trait DoctusGraphics {
  ...
  /** Set the fill color for subsequent drawings of shapes (ellipse, rect, ...)
    *
    * Values for alpha range from 0 to 255. 0 ... fully transparent 255 ...
    * fully opaque
    */
  ...
  /** Set the color for subsequent drawings of lines and the border of shapes
    * (ellipse, rect, ...)
    *
    * Values for alpha range from 0 to 255. 0 ... fully transparent 255 ...
    * fully opaque
  ...
  /** Sets the width in pixel of the stroke used for lines, points, and the
    * border around shapes.
    */
  def strokeWeight(weight: Double): Unit

  /** Disables drawing of borders for shapes (ellipse, rect, ...) Lines are
    * still drawn after the call to 'noStroke'
    */
  def noStroke(): Unit
  ...
  /** Draws a text using the current font. 'originX' and 'originY' define the
    * top left corner of the image. 'rotation' is the rotation angle of the text
    * in radians 0 is a horizontal text from left to right Pi/2 (90 deg) is a
    * vertical text going upward. In that case 'origin' is the bottom left
    * corner of the box surrounding the text
    */
  def text(
      str: String,
      originX: Double,
  ...
  /** Draws a text using the current font. 'origin' is the top left corner of
    * the image. 'rotation' is the rotation angle of the text in radians 0 is a
    * horizontal text from left to right Pi/2 (90 deg) is a vertical text going
    * upward. In that case 'origin' is the bottom left corner of the box
  ...
  /** Draws a rectangle 'originX' and 'originY' define the top left corner of
    * the rectangle.
    */
  def rect(
      originX: Double,
  ...
  /** Draws an ellipse 'centerX' and 'centerY' define the the center of the
    * ellipse 'a' and 'b' are the length of the semi major/minor of the ellipse
    */
  def ellipse(centerX: Double, centerY: Double, a: Double, b: Double): Unit

  /** Draws an ellipse 'center' is the the center of the ellipse 'a' and 'b' are
    * the length of the semi major/minor of the ellipse
    */
  ...
  /** Draws an image 'originX' and 'originY' define the top left corner of the
    * image.
    */
...
/** A component that can be activated and deactivated but does not provide a
  * position where it was activated E.g. A keyboard button that is pressed and
  * released, a keystroke ...
  */
...
/** A component that can be used for pointing E.g. a mouse or your Finger on a
  * touch device
  */
trait DoctusPointable {

  /** Defines a function that gets called whenever the pointing starts The point
    * (DoctusPoints) indicates where the pointing was started. E.g. where you
...
trait DoctusScheduler {
  ...
  /** Calls the function f every 'duration' milliseconds InitialDelay delays the
